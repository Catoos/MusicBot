...
module.exports = {
    ...
    aliases: ['skip', 'stop'],
    cooldown: 0,
    description: 'I swear I am not a music bot',
    async execute(client, message, args, cmd, Discord){

        const voice_channel = message.member.voice.channel;
        if(!voice_channel) return message.channel.send("Get yo ass in a channel");
        ...
        if(cmd === 'play'){
            if(!args.length) return message.channel.send('TF you want me to do with that?');
            let song = {};
            ...
            if(ytdl.validateURL(args[0])){
                ...
                if (video){
                    ...
                    message.channel.send('Im blind af frfr');
                }
            ...
            if(!server_queue){
                ...
                try{
                    ...
                    message.channel.send('Aw Shit I fucked up');
                    throw err;
                }
            } else {
